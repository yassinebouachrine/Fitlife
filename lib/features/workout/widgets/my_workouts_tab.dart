  ...
  void _deleteWorkout(int id) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: const Text('Workout deleted'), backgroundColor: Colors.green.shade700,
  ...
  Widget build(BuildContext context) {
    ...
    if (_error.isNotEmpty) {
      return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        ElevatedButton(onPressed: _loadWorkouts, child: const Text('Retry')),
      ]));
    }
        ...
        itemBuilder: (context, index) {
          if (index == 0) {
            return Padding(
              ...
              child: AppButton(label: 'Create new workout', icon: Icons.add_rounded, onPressed: () {}),
            );
          }
          ...
          return Padding(
            ...
            child: AppCard(child: Row(children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (val) { if (val == 'delete') _deleteWorkout(_toInt(w['id'])); },
                itemBuilder: (_) => [
