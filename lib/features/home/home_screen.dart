...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadDashboard() async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        setState(() {
          _error = response['message']?.toString() ?? 'Failed to load';
          _loading = false;
        });
      }
    } catch (e) {
  ...
  Widget _header(ColorScheme cs) => Row(children: [
        Expanded(
          ...
          Text(_userName,
              style: TextStyle(
                  fontSize: 26, fontWeight: FontWeight.w700, color: cs.onSurface, letterSpacing: -0.3)),
        ])),
        IconButton(
          onPressed: () {},
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(
            ...
            decoration:
                BoxDecoration(color: Colors.white.withOpacity(0.18), borderRadius: BorderRadius.circular(7)),
          ...
          Container(
            width: 40, height: 40,
            decoration:
                BoxDecoration(color: Colors.white.withOpacity(0.12), borderRadius: BorderRadius.circular(11)),
            ...
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Container(
                  width: 34, height: 34,
                  decoration:
                      BoxDecoration(color: col.withOpacity(0.08), borderRadius: BorderRadius.circular(9)),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(val,
                    style: TextStyle(
                        fontSize: 20, fontWeight: FontWeight.w700, color: cs.onSurface, letterSpacing: -0.3)),
  ...
  Widget _today(ColorScheme cs) {
    final icons = [
      Icons.fitness_center_outlined, Icons.self_improvement_outlined,
      Icons.directions_run_outlined, Icons.sports_outlined,
    ];
        ...
        ..._todayPrograms.asMap().entries.map((entry) {
          ...
          return Padding(
            ...
            child: _prog(
              ...
              _toInt(p['exercise_count']),
              _toInt(p['session_duration_min']),
              _toInt(p['xp_reward']),
                ...
                (i) => Column(children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: activityMap[i + 1] == true ? cs.primary : cs.outline.withOpacity(0.15),
                          shape: BoxShape.circle,
                        ),
                        child: activityMap[i + 1] == true
  ...
  Widget _qa(ColorScheme cs, IconData icon, String l, Color col) => AppCard(
        child: Column(children: [
          ...
          Text(l,
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: cs.onSurface, height: 1.3)),
        ]),
      );
}